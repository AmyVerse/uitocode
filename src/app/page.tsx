...
export default function Home() {
  return (
    <div className="relative font-[prompt] overflow-hidden">
      <section
        id="home"
        className="flex py-9 px-4 md:px-6 bg-[url('/bg.webp')] md:bg-[url('/bgalt.jpg')] bg-cover object-left bg-center bg-no-repeat h-screen w-screen flex-col items-left"
      >
        <Navbar />
        <div className="py-20 px-4 md:px-10 grid grid-rows-3 md:space-y-10">
          ...
          <div className="flex md:pt-14 grid-cols-2 h-fit items-center md:justify-start justify-evenly md:gap-32 max-md:-mt-8 md:w-fit">
            <button className="cursor-pointer rounded-2xl text-sm p-5 md:text-xl border-4 border-amber-500 w-24 md:w-32 h-8 md:h-12 flex items-center justify-center hover:bg-amber-500 hover:text-white transition-all duration-300">
              Explore
            </button>
            <button className="cursor-pointer rounded-2xl text-sm p-5 md:text-xl border-4 border-amber-500 w-24 md:w-32 h-8 md:h-12 flex items-center justify-center hover:bg-amber-500 hover:text-white transition-all duration-300">
              Customize
      ...
      <section
        id="collection"
        className="items-center flex px-4 md:px-7 py-9 bg-[url('/bg2.webp')] bg-cover bg-center bg-no-repeat h-fit pb-32 w-screen flex-col"
      >
        ...
        <div className="bg-black/30 w-full md:w-[1500px] h-auto md:h-120 rounded-[2rem] p-4 md:p-6 md:px-16 flex flex-col md:flex-row items-center justify-between shadow-2xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 md:gap-8 mx-4 md:mx-8 my-6 md:my-10">
            ...
            <Button
              ...
              classname="w-full md:mx-10 md:w-66 col-span-2 md:col-span-3"
            />
            <div className="hidden md:block col-span-1"></div>
